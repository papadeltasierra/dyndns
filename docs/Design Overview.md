...
3. Kubernetes
   ...
   2. Network Security
      ...
      3. [Diagram: Egress with policy enabled]
         1. [NetworkPolicy: Restricting API egress to only APIM and SQL]
      4. [APIM to API]
      5. RFC2136 Gateway
         1. [Restrict to port 53 only]
      6. [AKS to KeyVault]
      7. [Diagram: API to SQL Database]
         1. [NetworkPolicy: API to SQL database]
      8. [Diagram: Combined Network Policies]
4. GitHub
   1. CI/CD
      1. AKS
...
5. Microsoft Marketplace
   1. [Diagram: SaaS Provisioning]
...
[Diagram: DDNS Update Flow]: ./2-3-DDNS%20Update%20Flow.md
[Diagram: DDNS Authentication]: ./2-3-1-DDNS%20System%20Authentication.md
...
[Diagram: Enforcement Layers for AKS Security]: ./3-2-2-Enforcement%20Layers%20for%20AKS%20Security.md
[Diagram: Egress with policy enabled]: ./3-2-3-Traffic%20Flow%20With%20Egress%20Policy%20Enabled.md
[NetworkPolicy: Restricting API egress to only APIM and SQL]: ./3-2-3-1%20NetworkPolicy%20restricting%20API%20egress.md
...
[Diagram: API to SQL database]: ./3-2-7-API%20to%20SQL%20Traffic%20Flow.md
[NetworkPolicy: API to SQL database]: ./3-2-7-1-NetworkPolicy%20Allow%20Only%20API%20SQL%20Private.md
[Diagram: Combined Network Policies]: ./3-8-Combined%20Network%20Policies.md
...
[Deployment Sequence]: ./4-3-Deployment%20Sequence.md

[Diagram: SaaS Provisioning]: ./5-1-Microsoft%20Marketplace%20Provisioning.md